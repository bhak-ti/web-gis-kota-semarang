...
$provinsi= mysqli_real_escape_string($conect, $_POST['provinsi']);    //varibel field nama
$kabupaten= mysqli_real_escape_string($conect, $_POST['kabupaten']);    //varibel field stok
$kodedagri= mysqli_real_escape_string($conect, $_POST['kodedagri']);  //varibel field deskripsi
$kecamatan= mysqli_real_escape_string($conect, $_POST['kecamatan']);        //varibel field harga
$jml= mysqli_real_escape_string($conect, $_POST['jml']);  //varibel field kategori

if(isset($_POST['simpan'])){
 if(empty($provinsi)){    //jika nama kosong maka muncul pesan
        $error="<p style='color:#F00;'>* Masukan provinsi</p>";
    }
